...
usage() {
  cat <<'EOF'
Usage: scripts/codex-remote-proxy-check.sh [--with-proxy] [--proxy-mode socks-only|mixed|http-only]

Read-only diagnostics for Codex websocket and mobile remote-control proxy issues.
